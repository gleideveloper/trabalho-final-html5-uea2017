...
var GameStatePalafitas = function (game) {
}

GameStatePalafitas.prototype.create = function () {
...
GameStatePalafitas.prototype.update = function () {
...
GameStatePalafitas.prototype.setCollide = function () {
...
GameStatePalafitas.prototype.itemCollect = function (player, powerup) {
...
GameStatePalafitas.prototype.enemieCollision = function (player, bat) {
...
GameStatePalafitas.prototype.deathCollision = function () {
    this.levelPalafitas.setCollision([43, 44, 45], false, this.deathLayer);
    this.music.stop();
    this.lose();
}

// Condição de derrota: guarde o score e siga para o próximo estado
GameStatePalafitas.prototype.lose = function () {
...
GameStatePalafitas.prototype.createPowerUp = function () {
// Grupo de diamantes
    this.powerups = this.game.add.physicsGroup();
    this.levelPalafitas.createFromObjects('PowerUp', 'power', 'items', 5, true, false, this.powerups);
...
GameStatePalafitas.prototype.createEnemy = function () {
    // Grupo de morcegos:
    this.bats = this.game.add.physicsGroup();
    this.levelPalafitas.createFromObjects('Enemies', 'bat', 'enemies', 8, true, false, this.bats);
...
GameStatePalafitas.prototype.createScore = function () {
    // HUD de score
...
GameStatePalafitas.prototype.createSound = function () {
...
GameStatePalafitas.prototype.createControlKey = function () {
    this.keys = this.game.input.keyboard.createCursorKeys();
    this.jumpButton = this.game.input.keyboard.addKey(Phaser.Keyboard.SPACEBAR);
}

GameStatePalafitas.prototype.setParallaxBackground = function () {
...
GameStatePalafitas.prototype.createMapLevel1 = function () {
    //Cria o mapa e os layers do Tiled no Phaser
    this.levelPalafitas = this.game.add.tilemap('levelpalafitas');
    this.levelPalafitas.addTilesetImage('tiles64px', 'mapTiles');

    //Cria os layers
    this.levelPalafitas.createLayer('Bg')
    this.Bg01Layer = this.levelPalafitas.createLayer('Bg01');
    this.deathLayer = this.levelPalafitas.createLayer('Death');
    this.superJump = this.levelPalafitas.createLayer('SuperJump');
    this.trackLayer = this.levelPalafitas.createLayer('Track');

    //Define quais tiles do layer walls NÃO terão colisões
    this.levelPalafitas.setCollisionByExclusion([9, 10, 11, 12, 17, 18, 19, 20], true, this.trackLayer);

    // Define quais tiles do layer de death colidem
    this.levelPalafitas.setCollision([43, 44, 45], true, this.deathLayer);

    // Define quais tiles do layer do SuperJump colidem
    this.levelPalafitas.setCollision([41, 42], true, this.superJump);

    // Redimensionando o tamanho do "mundo" do jogo
    this.trackLayer.resizeWorld();
}

GameStatePalafitas.prototype.createPlayer = function () {
...
GameStatePalafitas.prototype.emenyMoviment = function () {
...
GameStatePalafitas.prototype.playerMovement = function () {
